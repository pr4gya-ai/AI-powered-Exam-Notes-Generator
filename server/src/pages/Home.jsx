...
import { Feature, transform } from 'framer-motion'
      ...
      <section className='max-w-7xl mx-auto px-8 pt-32 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        <div>
          ...
          style={{ transformStyle: 'preserve-3d' }}>
            ...
            <motion.p className='mt-6 text-lg text-lg bg-gradient-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent'
            whileHover={{y:-2}}
            style={{ 
              transform: "translateZ(40px)",
              textShadow: "0 18px 40px rgba(0,0,0,0.25)"}}
