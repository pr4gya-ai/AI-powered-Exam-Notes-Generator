...
function FinalResult({ result }) {
    ...
    return (
        <div className='mt-6 p-3 space-y-10 bg-white'>
            ...
            {(result.diagram?.data || result.questions?.diagram) && <section>
                <SectionHeader icon="📊" title="Diagram" color="cyan" />
                {console.log("FinalResult: Diagram data", result.diagram?.data || result.questions?.diagram)}
                <MermaidSetup diagram={result.diagram?.data || result.questions?.diagram} />
